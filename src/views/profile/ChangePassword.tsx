...
export default function ChangePasswordView() {
    ...
    const { register, handleSubmit, watch, reset, formState: { errors } } = useForm<UpdateCurrentUserPasswordForm>({ defaultValues: initialValues })
            ...
            <div className="mx-auto max-w-3xl">
                ...
                >
                    ...
                    <input
                        ...
                        className="bg-fuchsia-600 w-full p-3 rounded-lg text-white uppercase font-bold hover:bg-fuchsia-700 cursor-pointer transition-colors"
                    />
                </form>
            </div>
        </>
