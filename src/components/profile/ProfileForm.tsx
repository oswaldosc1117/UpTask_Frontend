        ...
        <>
            <div className="mx-auto max-w-3xl g">
                ...
                <form
                    ...
                    className=" mt-14 space-y-5 rounded-lg bg-white shadow-lg p-10 rounded-l"
                    noValidate
                >
                    ...
                    <input
                        ...
                        className="bg-fuchsia-600 w-full p-3 text-white uppercase rounded-lg font-bold hover:bg-fuchsia-700 cursor-pointer transition-colors"
                    />
                </form>
            </div>
        </>
